          ...
          return (
            <SwiperSlide key={slide.id}>
              <div className="lg:h-full item-inner">
                ...
                <div className="absolute z-20 flex flex-col items-center justify-center w-full px-5 text-center transform -translate-x-1/2 -translate-y-1/2 md:w-1/3 top-1/2 lg:top-2/3 item-content md:bottom-40 md:px-0 left-1/2 ">
